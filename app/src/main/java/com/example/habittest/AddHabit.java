...
//        EditText etHour = (EditText) findViewById(R.id.editText3);
        EditText etAim = (EditText) findViewById(R.id.editText4);
...
//        String strMin = etMin.getText().toString();
        ...
        String strAim= etAim.getText().toString();

        int num, hour, min,aim;
        ...
        if (strHour.equals("") && strMin.equals("")) {
            Date date = new Date();
            Habit habit = new Habit(name, img, num, 0, time, frequency, htext, 0, 0, 0, Utils.date2String(date), 1,aim);
